...
$sql = "SELECT * FROM Assigned_patient WHERE patient_id = :patient_id";
$stmt = $db->prepare($sql);
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE Assigned_patient SET patient_id = :patient_id, staff_id = :staff_id WHERE patient_id = :patient_id";
    $stmt = $db->prepare($sql);
    ...
    header('Location: ../manageAssignedDoctors.php?updated=1');
}
...
<div class="container bgColor">
    <main role="main" class="pb-5">
        <h2 style="text-align: center;">Update Doctor Assignment</h2>
        ...
        <div class="box">
            <form method="post">
                ...
                <div class="form-group col-md-14">
                    <label class="control-label labelFont" for="staff_id">Staff.ID</label>
                    <input class="form-control" type="text" name="staff_id" value="<?php echo $arrayResult[0][1]; ?>">
