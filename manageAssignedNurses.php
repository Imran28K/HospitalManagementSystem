...
include_once("manageAssignedNursesSQL.php");
$user = getNurse();
...
<div class="container pb-5">
    <main role="main" class="pb-3">
        <h2 style="font-family: 'Trebuchet MS', sans-serif; text-align: center;"> <strong>Nurse-Patient Assignment</strong> </h2>
        <br>

        <div style="display: flex; justify-content: center;">
            <a href="assignNurse.php"><button style="background-color: green; color: white; margin-left: -425px;">Assign Nurse</button></a>
